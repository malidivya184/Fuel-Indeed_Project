...
<body>
    <div class="dashboard">
        ...
        <div class="navbar">
            ...
            <a href="View_Fuelstation_Delivered_Bookings.jsp" class="nav-item"><i class="fas fa-check"></i> Delivered Bookings</a>
            <a href="Rejected_Bookings.jsp" class="nav-item"><i class="fas fa-times"></i> Rejected Bookings</a>
