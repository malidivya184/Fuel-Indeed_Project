        ...
        <div class="main-content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><a href="Aprovestation.jsp?stationid=<%= rs.getInt(1) %>">Approve</a></td>
                    <td><a href="DisapproveStation.jsp?stationid=<%= rs.getInt(1) %>">Disapprove</a></td>
                </tr>
                <%
                        }
                    } catch (Exception e) {
